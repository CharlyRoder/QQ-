package com.example.networks.adapter;
...
import com.example.networks.utils.DateUtil;
...
public class FriendExpandAdapter implements ExpandableListAdapter, OnGroupClickListener, OnChildClickListener {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        holder.tv_group_name.setText(group.group_title);
...
//        }
    ...
    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
        String desc = String.format("您点击了分组：%s", mGroupList.get(groupPosition).group_title);
        Toast.makeText(mContext, desc, Toast.LENGTH_SHORT).show();
        return false;
    }
