...
public class ClientThread implements Runnable {
    ...
    private static final String SOCKET_IP = "192.168.137.1";
    private static final int SOCKET_PORT = 51600;
    // 以下是HTTP接口调用的服务地址，根据实际情况修改IP和端口
    public static final String REQUEST_URL = "http://192.168.137.1:8086/Mandroidserver";
    ...
    public void run() {
        ...
        try {
            ...
            mSendHandler = new Handler(Looper.myLooper()) {
                // 接收到主线程的用户输入数据
                public void handleMessage(Message msg) {
                    try {
                        // 往输出流对象中写入数据
                        Log.d("msendhandlerme",msg.obj.toString());
